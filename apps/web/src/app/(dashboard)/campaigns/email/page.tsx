...
export default function EmailCampaignPage() {
  ...
  if (showForm) {
    return (
      <>
        <Header
          title={editingCampaign ? "Edit Email Campaign" : "Create Email Campaign"}
          description="Design and send emails to your members"
        />
        <div className="p-4 md:p-6">
          ...
          <div className="max-w-3xl space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    placeholder="e.g., Your January Fitness Update"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              {/* Main Categories */}
              <p className="text-sm text-slate-500 mb-3">Select who should receive this campaign</p>
                  ...
                  >
                    ...
                    <div>
                      <p className={`text-sm font-medium ${
                        targetAudience === option.value ? "text-indigo-700" : "text-slate-700"
                      }`}>{option.label}</p>
  ...
  return (
    <>
      <Header title="Email Campaigns" description="Create and manage email campaigns" />
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
            ...
            <p className="text-slate-500">No email campaigns yet</p>
            <button
              onClick={handleCreate}
                ...
                {campaigns.map((campaign) => (
                  <tr key={campaign.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={
                          Number(getOpenRate(campaign)) > 30
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={
                          Number(getClickRate(campaign)) > 10
                            ? "text-emerald-600 font-medium"
                            : "text-slate-600"
                        }
                      >
